  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            color: const Color.fromARGB(255, 0, 147, 5),
          ),
        ],
      ),
      body: _buildBody(),
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Color.fromARGB(255, 0, 147, 5),
      ),
    );
  }
          ...
          child: ListTile(
            ...
            trailing: IconButton(
              icon: Icon(
                ...
                color: isLiked ? const Color.fromARGB(255, 0, 147, 5) : null,
              ),
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    trailing: IconButton(
                      icon: const Icon(
                        Icons.favorite,
                        color: Color.fromARGB(255, 0, 147, 5),
                      ),
